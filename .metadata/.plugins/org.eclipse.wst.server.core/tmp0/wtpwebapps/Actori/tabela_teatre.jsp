...
<html>
 ...
 <br/>
 <p align="center"><a href="adauga_teatru.jsp"><b>Adauga un nou teatru.</b></a> <a
href="index.html"><b>Inapoi</b></a></p>
 ...
 <%
 jb.connect();
 ResultSet rs = jb.vedeTeatre();
 long x;
 while (rs.next()) {
 x = rs.getInt("idteatru");
 %>
 <tr>
